                ...
                return (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      {r.status === 'IDENTITY_VERIFICATION_REQUIRED' && (
                        <div className="mt-2 p-2.5 rounded-lg bg-amber-950/30 border border-amber-800/40 text-amber-300 text-xs flex items-center gap-2">
                          <svg className="w-4 h-4 shrink-0 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                          </svg>
                          <div>
                            <span className="font-semibold">{t('privacy.identityVerificationBanner')}:</span>{' '}
                            <span className="text-zinc-400">{t('privacy.identityVerificationBody')}</span>
                          </div>
                        </div>
                      )}
                    </div>
