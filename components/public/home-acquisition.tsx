...
export async function HomeAcquisition() {
  ...
  return (
    <section className="velvet-home-acquisition">
      ...
      <div><p>{t('home.professionalDescription')}</p><Link href={localizePathname('/anuncie', locale)}>{t('home.createProfile')} <span>→</span></Link></div>
      <span className="velvet-home-acquisition-mark" aria-hidden="true">
