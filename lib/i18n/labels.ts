...
const verification = {
  'pt-BR': {
    NOT_STARTED: 'AGUARDANDO INÍCIO', PENDING: 'AGUARDANDO CONCLUSÃO', IN_PROGRESS: 'EM ANDAMENTO',
    IN_REVIEW: 'EM ANÁLISE', VERIFIED: 'VERIFICADA', REJECTED: 'REJEITADA', EXPIRED: 'EXPIRADA',
  },
  en: {
    NOT_STARTED: 'WAITING TO START', PENDING: 'AWAITING COMPLETION', IN_PROGRESS: 'IN PROGRESS',
